...
function laplace1D_rhs_devec!(N::Int64,u::Array{Float64,1},out::Array{Float64,1})
...
function driver_devec(alpha::Float64,iter::Int64,N::Int64,a::Float64,b::Float64,u_out::Array{Float64,1})
    #Set up load vector.
    f=zeros(N-2)
